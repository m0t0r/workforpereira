...
There is no lint-config package (ADR-0017). The root `oxlint.config.mts` holds the baseline and each
...
- **Oxlint is the linter and TypeScript is 7.x — the two are one decision** (ADR-0017). TypeScript 7
