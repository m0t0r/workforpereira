...
| Column            | What it holds                    | _Finalidad_ that justifies it                                                                                                                                                                                                                                |
| ----------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `recipient_email` | Where the message goes           | `transactional_messages`, and nothing else — #70 removed `news` from the vocabulary, so every row in this table is a message about something the recipient did or that was done to them. It is the message's address and there is no way to send without it. |
