...
CREATE INDEX "notification_outbox_created_at_id_idx" ON "notification_outbox" USING btree ("created_at","id") WHERE "notification_outbox"."sent_at" is null;--> statement-breakpoint
